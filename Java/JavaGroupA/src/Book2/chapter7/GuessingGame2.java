...
//    public static int getRandomNumber() { //variant 3A
...
//    public static int getGuess() { //variant 1A
//        while (true) {
...
//    }
    ...
    public static int getGuess() { //variant 1B
        do {
            int guess = sc.nextInt();
            if ((guess < 1) || (guess > 10)) {
                System.out.println("Nope." + "\nOnly between 1 and 10." + "\nTry again.");
...
//    public static boolean askForAnotherRound() { //variant 2A
//        while (true) {
//            String answer;
...
//    }
    ...
    public static boolean askForAnotherRound() { //variant 2B
        boolean validInput;
        do {
            String answer;
            System.out.println("Shall we go again?" + "(Y or N)");
