...
public class WriteBinaryFile {
    public static void main(String[] args) {
        ...
        DataOutputStream out = openOutputStream("C:\\Users\\desmo\\Desktop\\Bootcamp\\Java\\JavaGroupA\\src\\Book8\\chapter2\\movies.dat");
        for (Movie m : movies){
            writeMovie(m, out);
        }
        closeFile(out);
    ...
    private static Movie[] getMovies(){
        ...
        movies[0] = new Movie("It's a Wonderful Life", 1940, 14.95);
