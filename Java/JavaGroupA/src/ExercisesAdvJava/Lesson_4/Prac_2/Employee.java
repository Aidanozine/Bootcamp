package ExercisesAdvJava.Lesson_4.Prac_2;

import ExercisesAdvJava.Lesson_4.Prac_2.Data.*;
...
public class Employee {
    public static void main(String[] args) {
        ...
        Engineer eng = new Engineer(101, "Ben Summers", "012-34-5678", 120_345.27);
        Employee emp = new Employee();

        // All engineers are employees hence upcasting is fine.
        // upcast ok with no explicit cast
        EmployeeData obj = new Engineer(102, "Judy Winters", "012-54-7812", 220_345.27);
        ...
        Engineer engobj =  new Engineer(1, "Mike Hannigan", "013-78-5678", 221_500.00);
