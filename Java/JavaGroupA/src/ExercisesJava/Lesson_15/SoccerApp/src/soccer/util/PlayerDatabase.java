package ExercisesJava.Lesson_15.SoccerApp.src.soccer.util;
...
public class PlayerDatabase {
    ...
    public Player[] getTeam(int numberOfPlayers) throws ExercisesJava.Lesson_15.SoccerApp.src.soccer.util.PlayerDatabaseException {
