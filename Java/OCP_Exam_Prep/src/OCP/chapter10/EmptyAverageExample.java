...
//        optionalScore.ifPresent(System.out::println); //essentially an if statement without an else statement
...
//---------------------------------------------------------------
//        Optional<Double> opt = average(); //input scores here
...
//        // type of factory method must match that of return type
        ...
        return Optional.ofNullable((double) sum / scores.length); //is factory method containing : Optional o = (sum == null) ? Optional.empty() : Optional.of((Double) sum / scores.length);
    }
}
